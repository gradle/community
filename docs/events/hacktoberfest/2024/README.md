...
3. Join the `#hacktoberfest` channel on the [Gradle Community Slack](https://gradle.org/slack-invite)
...
Join the `#hacktoberfest` channel on the [Gradle Community Slack](https://gradle.org/slack-invite)
